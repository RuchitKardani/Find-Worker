...
<?php
    ...
    $serviceTakerQuery = "SELECT service_taker_content, service_taker_image,service_taker_title FROM about_us";
    ...
    if ($serviceTakerRow = mysqli_fetch_assoc($serviceTakerResult)) {
        ...
        $serviceTakerImage = $serviceTakerRow['service_taker_image'];
    }

    // Fetch data for "SERVICE PROVIDER SIDE"
    $providerQuery = "SELECT provider_content, provider_image,provider_title FROM about_us";
    ...
    if ($providerRow = mysqli_fetch_assoc($providerResult)) {
        ...
        $providerImage = $providerRow['provider_image'];
...
?>
  ...
  <body class="host_version">
    ...
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
        ...
        <?php echo '<img src="admin/about_us_img/' . $serviceTakerImage . '" class="img-fluid img-rounded">';?>
...
<div class="row align-items-center">
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
        <div class="post-media wow fadeIn">
            <img src="<?php echo $providerImage; ?>" alt="Service Provider Image" class="img-fluid img-rounded">
        </div><!-- end media -->
    </div><!-- end col -->
    ...
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
        <div class="message-box">
            ...
            <p><h4>Efficient Schedule Management:</h4> Service providers can efficiently manage their schedules, ensuring they make the most of their available time.</p>
        </div><!-- end messagebox -->
    </div><!-- end col -->
</div><!-- end row -->
</div><!-- end container -->
                      ...
                      <div class="testi-carousel owl-carousel owl-theme">
                          <div class="testimonial clearfix">
                              <div class="testi-meta">
                                  <img src="images/harmesh.jpg" alt="" class="img-fluid">
