...
<script>
    $(document).ready(function () {
        $('.testi-carousel').owlCarousel({
            ...
            loop: true,
            autoplay: true,
            autoplayTimeout: 1000, // Adjust this value to set the time between each slide
        ...
        <div class="testi-carousel owl-carousel owl-theme">
            ...
            <div class="testimonial clearfix">
                ...
                <div class="desc">
                    ...
                    <p class="lead">The master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself because it is very pursue pleasure.</p>
                </div>
                <!-- end testi-meta -->
            </div>
            <!-- end testimonial -->
