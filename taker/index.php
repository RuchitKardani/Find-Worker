	...
	<body class="host_version">
		...
		<style>
			...
			#overviews::before {
				...
				/* Adjust the opacity (last value) to decrease/increase the brightness */
			}
		</style>
				...
				<div class="row">
					...
					if (mysqli_num_rows($result) > 0) {
						while ($row = mysqli_fetch_assoc($result)) {
							...
							echo '<img src="../admin/uploads/' . $row['image'] . '" alt="' . $row['servicetype'] . '" class="img-fluid">';
							echo ' </div>';
							echo '<div class="course-br">';
							echo '<div class="course-title">';
							echo '<h2><a href="#" title="' . $row['servicetype'] . '">' . $row['servicetype'] . '</a></h2>';
							echo '</div>';
							echo '<div class="course-desc">';
							echo '<p>' . $row['description'] . '</p>';
							echo '</div>';
							echo '<div class="course-rating">';
							echo '4.5 <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-half"></i>';
							// Generate the "BOOK NOW" button URL dynamically
							echo '<button class="book-button" onclick="window.location.href=\'workers/service.php?category=' . $row['servicetype'] . '\'">BOOK NOW</button>';
							echo '</div>';
							echo '</div>';
							echo '</div>';
							echo '<hr class="hr3">';
