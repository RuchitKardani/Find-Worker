        ...
        <div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-3">
                    ...
                    <img src=" <?php echo '../../provider/userdashboard/uploads/' . $image; ?>" class="" height=350px width=300px alt="Service Provider">
                </div>
                <div class="col-md-9">
                    <div class="card-body">
...
<center><h2 class="dates">Select The Dates From The Calender</h2></center>
                            <div id="calendar"></div>
