...
// Check if the service type is "agriculture"
$whereClause .= " AND servicetype = 'agriculture'";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        ?> <a href="booking.php?provider_id=<?php echo $row['id']; ?>" class="btn btn-primary"><span>BOOK NOW</span></a>
    ...
    echo "No user profiles found for the selected city.";
    echo '</div>';
}
