        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbars-host">
            <ul class="navbar-nav ml-auto">
              ...
              <!-- <li class="nav-item  dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item" href="Service-grid-2.php"> Grid 2 </a>
								
								<a class="dropdown-item" href="Service-grid-4.php"> Grid 4 </a>
							</div>
						</li> -->
            ...
            <ul class="nav navbar-nav navbar-right ">
              <div class="dropdown ">
                <a class="btn btn-secondary dropdown-toggle  bg-warning bg-gradient " href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Login/Registration
                </a>

                <ul class="dropdown-menu text-info bg-dark">
                  <li><a class="dropdown-item text-info bg-dark" href="login.php">Login</a></li>
                  <li><a class="dropdown-item text-info bg-dark" href="registration1.php">Registration</a></li>

                </ul>
              </div>
              <!-- <li><a class="hover-btn-new log orange" href="#" data-toggle="modal" data-target="#login"><span>login/Registration</span></a></li>	 -->
            </ul>
          </div>
        </div>
      </nav>
