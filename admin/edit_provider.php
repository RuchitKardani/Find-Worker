                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <select name="servicetype" id="servicetype" class="form-control">
                                                            <option value="agriculture" <?php if ($servicetype === 'agriculture') echo 'selected'; ?>>Agriculture</option>
                                                            <option value="plumber" <?php if ($servicetype === 'plumber') echo 'selected'; ?>>Plumber</option>
                                                            <option value="painter" <?php if ($servicetype === 'painter') echo 'selected'; ?>>Painter</option>
                                                            <option value="constructor" <?php if ($servicetype === 'constructor') echo 'selected'; ?>>Constructor</option>
                                                            <option value="mistri" <?php if ($servicetype === 'mistri') echo 'selected'; ?>>Mistri</option>
                                                            <option value="electrician" <?php if ($servicetype === 'electrician') echo 'selected'; ?>>Electrician</option>
                                                            <option value="driver" <?php if ($servicetype === 'driver') echo 'selected'; ?>>Driver</option>
                                                            <option value="tiles&marbels" <?php if ($servicetype === 'tiles&marbels') echo 'selected'; ?>>Tiles&Marbels</option>
                                                            <option value="pest control" <?php if ($servicetype === 'pest control') echo 'selected'; ?>>Pestcontrol</option>
                                                            <option value="all rounder" <?php if ($servicetype === 'all rounder') echo 'selected'; ?>>All Rounder</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
